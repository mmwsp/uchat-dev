...
void send_common_message(int client_socket){
    int message_type = 1;
    char *message = "Hdfhg sudfhg sdf js ydf bwk hjd gdgf jsdhf g.";
    ...
    json_object_object_add(json_obj, "chat_id", json_object_new_int(17)); //we need to throw here chat id, that we have saved from chat_init response
